  ...
  <div class="content window2">
    ...
    <div class="create-section">
      ...
      <div class="form-group">
        <label for="newFirstName2">First Name:</label>
        <input id="newFirstName2" type="text" bind:value={newFirstName} placeholder="Enter first name">
      </div>
      <div class="form-group">
        <label for="newLastName2">Last Name:</label>
        <input id="newLastName2" type="text" bind:value={newLastName} placeholder="Enter last name">
      </div>
      ...
      {:else}
        {#each users as user (user.id)}
          <div class="user-card">
            ...
            <div class="form-group">
              <label for={`first_${user.id}`}>First Name: <span class="badge read-only">Read Only</span></label>
              <input 
                id={`first_${user.id}`}
                type="text" 
            ...
            <div class="form-group">
              <label for={`last_${user.id}`}>Last Name: <span class="badge">Editable</span></label>
              <input 
                id={`last_${user.id}`}
                type="text" 
